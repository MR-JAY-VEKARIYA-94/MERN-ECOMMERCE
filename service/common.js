...
exports.sendMail = async function({ to, subject, text, html }){
      ...
      from: '"E-commerce" <order@ecommerce.com>',
      to,
      subject,
      text,
      html
 ...
 exports.cookieExtractor = function (req) {
  ...
  //token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY4MTIwYjdhNmEzNTVmOGRjZjk5NTM0YyIsInJvbGUiOiJhZG1pbiIsImlhdCI6MTc0NjAxMzEzOX0.GuAltj8J-KWJU16dNXxswfqJLbIPuWLnayzWFgvLHWE"
  return token;
};
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or concerns about your order, please <a href="23bmiit099@gmail.com">contact us</a>.</p>
            </td>
          </tr>
          <!-- end copy -->
